...
if defined?($test) && $test
  ...
  class TestResolveEtc < Test::Unit::TestCase
    ...
    def test_all
      # test_br
      ok_wi([:p, 't', [:br], 's'], "t~\ns\n")
      ok_eq("\342\200\276", '~'.set_sourcecode_charset.to_utf8)	# test bug
      ...
      ok_wi(['nosuch plugin'], '{{nosuchplugin}}')
  ...
  class TestFormatter < Test::Unit::TestCase
    ...
    def test_all1b
      ...
      # test_plugin_link
      ok_wi("<p><a href=\".recent\">.recent</a></p>", '[[.recent]]')
      ok_wi("<p><a href=\".recent\">RecentList</a></p>",
	    '[[RecentList|.recent]]')
      ok_wi("<p><a href=\".rss\">.rss</a></p>",
	    '[[.rss]]') # not use for now
    ...
    def test_all3
      ...
      page.store('*‚ ')
      k = page.key
      ok_wi("<p><a href=\"#{k}.html\">‚ </a></p>", "[[#{k}]]")

      # test_find_title
      ok_wi("<p><a href=\"#{k}.html\">‚ </a></p>", '[[‚ ]]')
    end
