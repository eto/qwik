...
class QRCodeView
  ...
  def generate_html(d)
    ...
    return QRCodeView.generate_html(@qrcode.make_qrcode(d))
  end
  ...
  def generate_wabisabi(d)
    return nil unless have_qrcode_data
    return QRCodeView.generate_wabisabi(@qrcode.make_qrcode(d))
  end
  ...
  def generate(d)
    return nil unless have_qrcode_data
    return nil unless have_gd
    return QRCodeView.generate_png(@qrcode.make_qrcode(d))
  end
...
if defined?($test) && $test
  class TestQRCodeView < Test::Unit::TestCase
	...
	c.generate_wabisabi('01').rb_format_xml(-1, -1)
      ...
      assert_equal "\211PNG\r\n\032\n\000\000\000\rIHDR\000\000\000\003\000\000\000\003\001\003\000\000\000l\346'\374\000\000\000\006PLTE\377\377\377\000\000\000U\302\323~\000\000\000\016IDAT\010\231c``p``\000\000\000\306\000A\316q\f\035\000\000\000\000IEND\256B`\202", c.mkimage('1', 1, 1).pngStr
    end
