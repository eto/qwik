...
if defined?($test) && $test
  class MockMLGetText
    ...
    def test_all(t)
      ...
      t.ok_eq('‚±‚ñ‚É‚¿‚Í'.set_sourcecode_charset.to_mail_charset, gettext('hello'))
      t.ok_eq('‚±‚ñ‚É‚¿‚Í'.set_sourcecode_charset.to_mail_charset, _('hello'))
      t.ok_eq('‚±‚ñ‚É‚¿‚Í'.set_sourcecode_charset.to_mail_charset, gettext2('hello'))
      t.ok_eq('‚±‚ñ‚É‚¿‚Í'.set_sourcecode_charset.to_mail_charset, gettext('hello'))
